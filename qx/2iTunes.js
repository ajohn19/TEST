/*
  ...
  sjbla 为 带有到期时间数据
  sjblb 为 不带到期时间数据
  sjblc 为 不带任何数据 目前 PutApp 用着
  sjbld 为 多个购买数据，第一无时间数据，第二有时间数据，目前 Metion 用着
  version 版本号
  //核心内容
  hxpda 为 订阅数据，比较常用。
  hxpdb 为 个别APP使用，不带其他数据
  内购数据product_id
  pro  member  month  yearly  premium_year  annually  free  year  forever  premium  life  lifetime  one  one_year_plus  VIPYear  yearvip  tenured  permanent  perpetual  lifelongly  foreverly  lifetimely  permanently  yearlysubscription

使用此脚本，会导致AppleStore无法切换账户，解决方法[ 关闭QX，关闭MITM，关闭脚本 ]

  'BuBuSZ': { cm: 'sjbla', hx: 'hxpda', id: "quaVersion", latest: "chxm1023" },  //无版本号
  'CapyMood': { cm: 'sjbla', hx: 'hxpda', version: "1.1.0.3", id: "com.paha.CapyMood.year", latest: "chxm1023" },  //带版本号
